...
class Admin_Page {
    ...
    public function register_menu() {
        add_menu_page( 'Extensions (DT)', 'Extensions (DT)', $this->permissions, $this->token, [ $this, 'extensions_menu' ], 'dashicons-admin-generic', 59 );
        add_submenu_page( $this->token, $this->title, $this->title, $this->permissions, $this->token, [ $this, 'content' ] );
    }
